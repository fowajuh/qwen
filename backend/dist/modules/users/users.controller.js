...
let UsersController = class UsersController {
    ...
    updateMe(user, body) {
        const parsed = update_profile_dto_1.UpdateProfileDto.safeParse(body);
        if (!parsed.success)
    ...
    updateSubscription(user, body) {
        const { plan, billingCycle } = body;
        if (!['explorer', 'voyager', 'crew'].includes(plan)) {
            throw new common_1.UnauthorizedException('invalid plan');
        }
        if (!['monthly', 'annual'].includes(billingCycle)) {
            throw new common_1.UnauthorizedException('invalid billing cycle');
        }
...
__decorate([
    (0, common_1.Patch)('me/subscription'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
...
__decorate([
    (0, common_1.Delete)('me/subscription'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
