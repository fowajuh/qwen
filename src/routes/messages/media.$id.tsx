...
export const Route = createFileRoute("/messages/media/$id")({
  component: MessagesMediaId,
});

function MessagesMediaId() {
  ...
  return (
    <div className="w-full min-h-screen bg-background p-4 pt-safe animate-in fade-in duration-300">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-xl font-bold tracking-tight">MessagesMediaId</h1>
      </div>
