...
function MapPage() {
  const { location, error: locError, isLoading: locLoading, requestPermission } = useGeolocation();
  const { businesses, housing, isLoading: scoutLoading, refetch, status } = useScoutData(location);
